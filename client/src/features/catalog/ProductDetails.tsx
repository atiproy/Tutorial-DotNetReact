...
export default function ProductDetails() {
    ...
    useEffect(() => {
        if (item) setQuantity(item.quanity);
    ...
    function handleUpdateCart() {
        setSubmitting(true)
        if (!item || quantity > item.quanity) {
            const updateQuantity = item ? quantity - item.quanity : quantity;
            ...
            const updateQuantity = item.quanity - quantity;
        ...
        <Grid container spacing={6}>
            ...
            <Grid item xs={6}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <LoadingButton
                            disabled={item?.quanity === quantity || !item && quantity === 0}
                            loading={submitting}
